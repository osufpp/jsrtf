...
var jsRTF = inherit(/** @lends jsRTF.prototype */{
    ...
    /** Stores lines with multiple inline styles */
    lines: [],
    ...
    composeInlineText: function (text, lineName) {
        var line = this.lines.find(line => line.name === lineName)
        if (!line) {
            line = {name: lineName, text: text};
    ...
    addInlineText: function (lineName) {
        var line = this.lines.find(line => {
            return line.name === lineName
        })
        console.log("line:", line)
        if (line) {
            this.addElement({ text: line.text, inLineStyling: true });
        }
    },
