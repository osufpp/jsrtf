...
module.exports = {
    ...
    getRTFSafeText : function (text){
        console.log("text in getRTFSafeText: ", text);
        // inline styling
        if ( typeof text === 'object' && text.hasOwnProperty('text') && text.inLineStyling ) {
            // replace \\ with \
            const result = text.text.replace(/\\\\/g, '\\');
            console.log("result in getRTFSafeText: ", result);
            return result;
        }
